...
const validateBulkUpdate = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
// 3. Apply Bulk Update
const applyBulkUpdate = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield prismaClient_1.default.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
            var _a;
            // @ts-ignore
            const batch = yield tx.bulkUpdateBatch.create({
                data: {
                    updateType,
                    status: "Completed"
                }
