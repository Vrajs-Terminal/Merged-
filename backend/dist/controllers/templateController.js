...
const getTemplates = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const tables = yield prismaClient_1.default.$queryRawUnsafe("SHOW TABLES");
...
const getTemplateById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const template = yield prismaClient_1.default.template.findUnique({
            where: { id: Number(id) },
...
const createTemplate = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const template = yield prismaClient_1.default.template.create({
            data: {
                name,
                description,
                groupName,
...
const updateTemplate = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const { name, description, groupName, templateType, allowMultiplePerShift, requiredOnPunchIn, requiredOnPunchOut, needReportingPerson } = req.body;
        const template = yield prismaClient_1.default.template.update({
            where: { id: Number(id) },
            data: {
                name,
                description,
...
const toggleTemplateStatus = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const template = yield prismaClient_1.default.template.findUnique({ where: { id: Number(id) } });
        if (!template) {
            return res.status(404).json({ message: "Template not found" });
        }
        const updatedTemplate = yield prismaClient_1.default.template.update({
            where: { id: Number(id) },
...
const deleteTemplate = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        yield prismaClient_1.default.template.delete({
            where: { id: Number(id) },
        });
