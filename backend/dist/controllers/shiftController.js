...
const createShift = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const shift = yield prisma_1.default.shift.create({ data: shiftData });
...
const getShifts = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const updateShift = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const shift = yield prisma_1.default.shift.update({ where: { id }, data: shiftData });
...
const deleteShift = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = toInt(req.params["id"]);
        yield prisma_1.default.shift.delete({ where: { id } });
...
const assignShift = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const assignments = yield Promise.all(employeeIds.map((empId) => prisma_1.default.shiftAssignment.upsert({
            where: {
...
const getAssignments = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const assignments = yield prisma_1.default.shiftAssignment.findMany({
            where,
            include: {
...
const deactivateAssignment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = toInt(req.params["id"]);
        const assignment = yield prisma_1.default.shiftAssignment.update({
            where: { id },
...
// ─── SHIFT ROTATIONS ─────────────────────────────────────────────────────────
const createRotation = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const rotation = yield prisma_1.default.shiftRotation.create({
            data: Object.assign(Object.assign({}, req.body), { cycleStartDate: new Date(String(req.body.cycleStartDate)), shiftSequence: JSON.stringify(req.body.shiftSequence) })
        });
...
const getRotations = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const rotations = yield prisma_1.default.shiftRotation.findMany({ orderBy: { createdAt: "desc" } });
        res.json({ rotations });
    }
    catch (err) {
...
const updateRotation = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = toInt(req.params["id"]);
        ...
        const rotation = yield prisma_1.default.shiftRotation.update({ where: { id }, data });
...
const deleteRotation = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = toInt(req.params["id"]);
        yield prisma_1.default.shiftRotation.delete({ where: { id } });
...
// ─── SHIFT STATS / REPORTS ────────────────────────────────────────────────────
const getShiftStats = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const [totalShifts, activeAssignments, totalRotations, shiftList] = yield Promise.all([
...
const createShiftChangeRequest = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { employeeId, requestedShiftId, date, reason } = req.body;
        const request = yield prisma_1.default.shiftChangeRequest.create({
            data: {
...
const getShiftChangeRequests = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const requests = yield prisma_1.default.shiftChangeRequest.findMany({
            include: {
...
const updateShiftChangeStatus = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = toInt(req.params["id"]);
        const { status } = req.body; // Approved / Rejected
        const request = yield prisma_1.default.shiftChangeRequest.update({
            where: { id },
            data: { status }
        });
...
// ─── SHIFT PENALTY RULES ─────────────────────────────────────────────────────
const createPenaltyRule = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { name, type, thresholdMin, deductionAmt, dayDeduction, status } = req.body;
        const rule = yield prisma_1.default.shiftPenaltyRule.create({
            data: {
                name,
                type,
...
const getPenaltyRules = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const rules = yield prisma_1.default.shiftPenaltyRule.findMany({ orderBy: { createdAt: "desc" } });
        res.json({ rules });
    }
    catch (err) {
...
const deletePenaltyRule = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = toInt(req.params["id"]);
        yield prisma_1.default.shiftPenaltyRule.delete({ where: { id } });
