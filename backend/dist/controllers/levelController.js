...
const createLevel = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const existing = yield prismaClient_1.default.level.findUnique({
            where: { levelName }
        });
        if (existing) {
            return res.status(400).json({ error: "Level name already exists" });
        }
        const level = yield prismaClient_1.default.level.create({
            data: {
                levelName,
                levelCode,
                description,
...
const updateLevel = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const level = yield prismaClient_1.default.level.update({
            where: { id: levelId },
            data: {
                levelName,
                levelCode,
...
const deleteLevel = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const assignedEmployees = yield prismaClient_1.default.employee.findFirst({
        ...
        const subLevels = yield prismaClient_1.default.level.findFirst({
        ...
        yield prismaClient_1.default.level.delete({
            where: { id: levelId }
        });
...
const assignLevel = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield prismaClient_1.default.$transaction((prisma) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const activeHistory = yield prisma.levelHistory.findFirst({
                where: {
            ...
            if (activeHistory) {
                yield prisma.levelHistory.update({
                    where: { id: activeHistory.id },
                    data: { effectiveTo: new Date(effectiveFrom) }
                });
            }
            // Create new Level History record
            const newHistory = yield prisma.levelHistory.create({
                data: {
                    employeeId: Number(employeeId),
...
const getEmployeeLevelHistory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const history = yield prismaClient_1.default.levelHistory.findMany({
    ...
    try {
        ...
        const buildTree = (parentId) => {
            return levels
                ...
                .map(l => (Object.assign(Object.assign({}, l), { children: buildTree(l.id) })));
        };
