...
const getDailySalesReport = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getDailySalesRecord = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const record = yield prismaClient_1.default.dailySalesAggregate.findUnique({
...
const createDailySalesRecord = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const record = yield prismaClient_1.default.dailySalesAggregate.create({
            data: {
...
const updateDailySalesRecord = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const { orderCount, totalQuantity, salesAmount, distributor, city } = req.body;
        const record = yield prismaClient_1.default.dailySalesAggregate.update({
            where: { id: parseInt(id) },
            data: Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, (orderCount !== undefined && { orderCount: parseInt(orderCount) })), (totalQuantity !== undefined && { totalQuantity: parseInt(totalQuantity) })), (salesAmount !== undefined && { salesAmount: parseFloat(salesAmount) })), (distributor && { distributor })), (city && { city })),
            include: { employee: true }
        });
...
const deleteDailySalesRecord = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        yield prismaClient_1.default.dailySalesAggregate.delete({
            where: { id: parseInt(id) }
        });
...
const getSummaryByEmployee = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const records = yield prismaClient_1.default.dailySalesAggregate.findMany({
            where,
            include: { employee: true }
        });
        const summary = {
