...
const getExpenseCategories = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const items = yield prismaClient_1.default.expenseCategory.findMany({});
        res.json(items);
    }
    catch (error) {
...
const createExpenseCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = req.body;
        const item = yield prismaClient_1.default.expenseCategory.create({ data });
...
const updateExpenseCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const data = req.body;
        const item = yield prismaClient_1.default.expenseCategory.update({
            where: { id: Number(id) },
            data
        });
        res.json(item);
...
const deleteExpenseCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        yield prismaClient_1.default.expenseCategory.delete({ where: { id: Number(id) } });
