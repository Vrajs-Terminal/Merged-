...
const getEntries = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (status)
            where.status = status;
        const entries = yield prismaClient_1.default.expenseEntry.findMany({
            where,
            include: {
...
const createEntry = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const entry = yield prismaClient_1.default.expenseEntry.create({
            data: {
...
const approveEntry = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const { approvedBy } = req.body;
        const entry = yield prismaClient_1.default.expenseEntry.update({
            where: { id: Number(id) },
...
const rejectEntry = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
...
const bulkMarkPaid = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { ids, paymentMode, voucherNo, paidBy } = req.body;
        if (!Array.isArray(ids))
            return res.status(400).json({ error: 'ids[] required' });
        yield prismaClient_1.default.expenseEntry.updateMany({
...
const getGroupWise = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const entries = yield prismaClient_1.default.expenseEntry.findMany({
...
const getDayWise = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const entries = yield prismaClient_1.default.expenseEntry.findMany({
