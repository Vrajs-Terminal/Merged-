...
const getAllRetailers = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const [retailers, total] = yield Promise.all([
...
const updateRetailer = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const retailer = yield prismaClient_1.default.retailer.update({
            where: { id: parseInt(id) },
            data: Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, (name && { name })), (contactNumber && { contactNumber })), (distributorId && { distributorId: parseInt(distributorId) })), (area && { area })), (city && { city })), (stateId && { stateId: parseInt(stateId) })), (type && { type })), (gst && { gst })), (status && { status })),
            include: { distributor: true, state: true }
        });
...
const deleteRetailer = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        yield prismaClient_1.default.retailer.delete({
            where: { id: parseInt(id) }
        });
...
// Toggle status
const toggleRetailerStatus = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const retailer = yield prismaClient_1.default.retailer.findUnique({
            where: { id: parseInt(id) }
        ...
        const updated = yield prismaClient_1.default.retailer.update({
            where: { id: parseInt(id) },
