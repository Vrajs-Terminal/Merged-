...
const getQuestionsByTemplate = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { templateId } = req.params;
        const questions = yield prismaClient_1.default.templateQuestion.findMany({
...
const createQuestion = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const question = yield prismaClient_1.default.templateQuestion.create({
            data: {
...
const updateQuestion = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const question = yield prismaClient_1.default.templateQuestion.update({
            where: { id: Number(id) },
            data: {
                questionTitle,
                placeholder,
...
const deleteQuestion = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        yield prismaClient_1.default.templateQuestion.delete({
            where: { id: Number(id) },
        });
