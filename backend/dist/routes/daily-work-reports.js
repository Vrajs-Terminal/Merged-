...
router.get('/', authMiddleware_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const reports = yield prismaClient_1.default.dailyWork.findMany({
            where: whereClause,
            include: {
                user: {
                    select: {
...
router.get('/:id', authMiddleware_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const report = yield prismaClient_1.default.dailyWork.findUnique({
            where: { id },
            include: {
                user: {
                    select: {
...
router.patch('/:id/status', authMiddleware_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updatedReport = yield prismaClient_1.default.dailyWork.update({
            where: { id },
            data: {
                status,
                admin_remark: remark
        ...
        yield (0, activityLogger_1.logActivity)(null, 'UPDATED', 'DAILY_WORK_REPORT', `Updated report ${id} status to ${status}`);
...
// GET export reports
router.get('/export', authMiddleware_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
