...
router.get('/dashboard', authMiddleware_1.authenticateToken, (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const now = new Date();
        ...
        const trackingEnabled = yield prismaClient_1.default.trackingConfig.count({ where: { enabled: true } });
        // Today's logs
        const todayLogs = yield prismaClient_1.default.trackingLog.findMany({
        ...
        // Exceptions today
        const todayExceptions = yield prismaClient_1.default.trackingException.count({
            where: { createdAt: { gte: todayStart, lt: todayEnd } }
        });
        // Geofence violations today
        const geofenceViolations = yield prismaClient_1.default.trackingException.count({
            where: {
        ...
        const checkIns = yield prismaClient_1.default.trackingLog.findMany({
            where: { timestamp: { gte: todayStart, lt: todayEnd } },
...
router.get('/live', authMiddleware_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.get('/history', authMiddleware_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const logs = yield prismaClient_1.default.trackingLog.findMany({
            where: whereClause,
            include: {
                user: {
                    select: {
...
router.get('/history/export', authMiddleware_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
