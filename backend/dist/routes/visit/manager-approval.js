...
router.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const [visits, total] = yield Promise.all([
            ...
            prismaClient_1.default.visit.count({ where })
        ]);
        res.json({
            data: visits,
            meta: {
...
router.post('/:id/decision', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updated = yield prismaClient_1.default.visit.update({
            where: { id: visitId },
            data: {
                status: finalStatus,
