...
router.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const subDepts = yield prismaClient_1.default.subDepartment.findMany({
...
router.post('/bulk', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const currentMax = yield prismaClient_1.default.subDepartment.aggregate({
        ...
        yield prismaClient_1.default.subDepartment.createMany({
            data: dataToInsert,
            skipDuplicates: true // Will skip if unique constraint (name + dept) fails
        });
        const user = req.user;
        yield Promise.all(names.map((n) => (0, activityLogger_1.logActivity)((user === null || user === void 0 ? void 0 : user.id) || null, 'CREATED', 'SUB_DEPARTMENT', n.trim())));
...
router.put('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const updated = yield prismaClient_1.default.subDepartment.update({
            where: { id: parseInt(id) },
            data: { name: name.trim() }
        });
        const user = req.user;
        yield (0, activityLogger_1.logActivity)((user === null || user === void 0 ? void 0 : user.id) || null, 'UPDATED', 'SUB_DEPARTMENT', updated.name);
        res.json(updated);
    }
    catch (error) {
...
router.put('/action/reorder', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield (0, activityLogger_1.logActivity)((user === null || user === void 0 ? void 0 : user.id) || null, 'REORDERED', 'SUB_DEPARTMENT', 'Reordered sub-departments');
...
router.delete('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const subDept = yield prismaClient_1.default.subDepartment.findUnique({
            where: { id: parseInt(id) },
        ...
        const user = req.user;
        yield prismaClient_1.default.subDepartment.delete({ where: { id: parseInt(id) } });
        yield (0, activityLogger_1.logActivity)((user === null || user === void 0 ? void 0 : user.id) || null, 'DELETED', 'SUB_DEPARTMENT', subDept.name);
