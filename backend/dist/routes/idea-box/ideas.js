...
router.get('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const idea = yield prismaClient_1.default.idea.findUnique({
...
router.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const idea = yield prismaClient_1.default.idea.create({
            data: {
                title: title.trim(),
 ...
 */
router.post('/:id/vote', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const existingVote = yield prismaClient_1.default.ideaVote.findUnique({
            where: {
                ideaId_userId: { ideaId, userId: Number(user_id) }
            }
        });
        if (existingVote) {
            yield prismaClient_1.default.ideaVote.delete({ where: { id: existingVote.id } });
            return res.json({ voted: false, message: 'Vote removed' });
        }
        else {
            yield prismaClient_1.default.ideaVote.create({
...
router.post('/:id/comment', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const comment = yield prismaClient_1.default.ideaComment.create({
            data: {
                ideaId,
                userId: Number(user_id),
...
router.delete('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const idea = yield prismaClient_1.default.idea.findUnique({ where: { id } });
        if (!idea)
            return res.status(404).json({ error: 'Idea not found' });
        yield prismaClient_1.default.idea.delete({ where: { id } });
