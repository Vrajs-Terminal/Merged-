...
router.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const slots = yield prismaClient_1.default.parkingSlot.findMany({
            include: {
                user: {
...
router.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const newSlot = yield prismaClient_1.default.parkingSlot.create({
            data: {
                slot_number,
        ...
        yield (0, activityLogger_1.logActivity)(null, 'CREATED', 'PARKING_SLOT', `Created Slot ${slot_number}`);
...
router.put('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const { id } = req.params;
        const { slot_number, user_id, vehicle_number, access_type, status } = req.body;
        const updatedSlot = yield prismaClient_1.default.parkingSlot.update({
        ...
        yield (0, activityLogger_1.logActivity)(null, 'UPDATED', 'PARKING_SLOT', `Updated Slot ${slot_number}`);
...
router.delete('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const slot = yield prismaClient_1.default.parkingSlot.delete({
            where: { id: parseInt(id) }
        });
        yield (0, activityLogger_1.logActivity)(null, 'DELETED', 'PARKING_SLOT', `Deleted Slot #${id}`);
        res.status(204).send();
    }
    catch (error) {
