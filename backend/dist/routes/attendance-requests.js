...
router.post('/', authMiddleware_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const request = yield prismaClient_1.default.attendanceRequest.create({
            data: {
                user_id: user.id,
                request_type,
                date: dateObj,
        ...
        yield (0, activityLogger_1.logActivity)(user.id, 'CREATED', 'ATTENDANCE_REQUEST', request_type);
...
router.get('/', authMiddleware_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const requests = yield prismaClient_1.default.attendanceRequest.findMany({
            where: whereClause,
            include: {
...
// =====================================
router.put('/:id/review', authMiddleware_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    ...
    try {
        const request = yield prismaClient_1.default.attendanceRequest.update({
        ...
        yield (0, activityLogger_1.logActivity)(user.id, 'UPDATED', 'ATTENDANCE_REQUEST', `Request #${id} marked as ${status}`);
...
router.delete('/:id', authMiddleware_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = req.user;
    try {
        const existing = yield prismaClient_1.default.attendanceRequest.findUnique({ where: { id: parseInt(id) } });
        if (!existing)
        ...
        yield prismaClient_1.default.attendanceRequest.delete({ where: { id: parseInt(id) } });
        yield (0, activityLogger_1.logActivity)(user.id, 'DELETED', 'ATTENDANCE_REQUEST', `Cancelled request #${id}`);
