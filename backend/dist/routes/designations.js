...
router.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const designations = yield prismaClient_1.default.designation.findMany({
...
router.post('/bulk', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const currentMax = yield prismaClient_1.default.designation.aggregate({
        ...
        yield prismaClient_1.default.designation.createMany({
            data: dataToInsert,
            skipDuplicates: true
        });
        const user = req.user;
        yield Promise.all(names.map((n) => (0, activityLogger_1.logActivity)((user === null || user === void 0 ? void 0 : user.id) || null, 'CREATED', 'DESIGNATION', n.trim())));
...
router.put('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const updated = yield prismaClient_1.default.designation.update({
            where: { id: parseInt(id) },
            data: { name: name.trim() }
        });
        const user = req.user;
        yield (0, activityLogger_1.logActivity)((user === null || user === void 0 ? void 0 : user.id) || null, 'UPDATED', 'DESIGNATION', updated.name);
        res.json(updated);
    }
    catch (error) {
...
router.put('/action/reorder', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield (0, activityLogger_1.logActivity)((user === null || user === void 0 ? void 0 : user.id) || null, 'REORDERED', 'DESIGNATION', 'Reordered designations');
...
router.delete('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const user = req.user;
        yield prismaClient_1.default.designation.delete({ where: { id: parseInt(id) } });
        yield (0, activityLogger_1.logActivity)((user === null || user === void 0 ? void 0 : user.id) || null, 'DELETED', 'DESIGNATION', `Designation #${id}`);
