...
router.post('/bind', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { user_id, macAddress, deviceId, deviceName } = req.body;
        if (!user_id)
            return res.status(400).json({ error: 'User ID is required' });
        const device = yield prisma.mobileDevice.upsert({
...
// Unbind a device
router.post('/unbind', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { user_id } = req.body;
        if (!user_id)
            return res.status(400).json({ error: 'User ID is required' });
        const device = yield prisma.mobileDevice.update({
            where: { userId: Number(user_id) },
            data: {
                status: 'Unbound',
                macAddress: null,
...
router.post('/reset', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!user_id)
            return res.status(400).json({ error: 'User ID is required' });
        yield prisma.mobileDevice.delete({
            where: { userId: Number(user_id) }
        });
...
router.patch('/toggle-status', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
