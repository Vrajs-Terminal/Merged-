...
router.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (department_id)
            where.site = Object.assign(Object.assign({}, where.site), { department_id: Number(department_id) });
        const employees = yield prismaClient_1.default.siteEmployee.findMany({
            where,
            include: {
...
router.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        for (const user_id of user_ids) {
            ...
            const existing = yield prismaClient_1.default.siteEmployee.findUnique({
            ...
            const emp = yield prismaClient_1.default.siteEmployee.create({
                data: {
...
router.put('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updated = yield prismaClient_1.default.siteEmployee.update({
            where: { id: Number(id) },
            data: {
                role,
...
router.delete('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        yield prismaClient_1.default.siteEmployee.delete({
            where: { id: Number(id) }
        });
