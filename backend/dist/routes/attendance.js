 ...
 * Web Punch (In or Out)
 */
router.post('/web-punch', authMiddleware_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = req.user;
        const now = new Date();
        ...
        let record = yield prismaClient_1.default.attendanceRecord.findUnique({
        ...
        if (!record) {
            ...
            record = yield prismaClient_1.default.attendanceRecord.create({
                data: {
                    user_id: user.id,
                    date: dateObj,
                    in_time: now,
            ...
            yield (0, activityLogger_1.logActivity)(user.id, 'CREATED', 'ATTENDANCE_PUNCH_IN', 'Web Punch In');
            ...
            record = yield prismaClient_1.default.attendanceRecord.update({
                where: { id: record.id },
                data: {
                    out_time: now,
            ...
            yield (0, activityLogger_1.logActivity)(user.id, 'UPDATED', 'ATTENDANCE_PUNCH_OUT', 'Web Punch Out');
...
router.get('/', authMiddleware_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const records = yield prismaClient_1.default.attendanceRecord.findMany({
            where: whereClause,
            include: {
                user: {
                    select: {
 ...
 */
router.get('/dashboard-stats', authMiddleware_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { date: dateStr } = req.query;
        const targetDate = dateStr ? new Date(dateStr) : new Date();
        targetDate.setHours(0, 0, 0, 0);
        const totalEmployees = yield prismaClient_1.default.user.count();
        const statusCounts = yield prismaClient_1.default.attendanceRecord.groupBy({
            by: ['status'],
        ...
        for (let i = 4; i >= 0; i--) {
            ...
            const dayCounts = yield prismaClient_1.default.attendanceRecord.groupBy({
                by: ['status'],
                where: { date: d },
                _count: { status: true }
            });
 ...
 */
router.get('/month-wise', authMiddleware_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
 ...
 * Weekly Attendance
 */
router.get('/weekly', authMiddleware_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
 ...
 */
router.post('/manual', authMiddleware_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const existing = yield prismaClient_1.default.attendanceRecord.findUnique({
        ...
        const record = yield prismaClient_1.default.attendanceRecord.create({
            data: {
        ...
        yield (0, activityLogger_1.logActivity)(adminUser.id, 'CREATED', 'ATTENDANCE_MANUAL', `Manual attendance for user ${user_id}`);
...
router.put('/:id', authMiddleware_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const existing = yield prismaClient_1.default.attendanceRecord.findUnique({ where: { id: parseInt(id) } });
        if (!existing)
        ...
        const record = yield prismaClient_1.default.attendanceRecord.update({
            where: { id: parseInt(id) },
            data: updateData
        });
        yield (0, activityLogger_1.logActivity)(adminUser.id, 'UPDATED', 'ATTENDANCE_RECORD', `Updated record #${id}`);
...
router.delete('/:id', authMiddleware_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!existing)
            return res.status(404).json({ error: 'Record not found' });
        yield prismaClient_1.default.attendanceRecord.delete({ where: { id: parseInt(id) } });
        yield (0, activityLogger_1.logActivity)(adminUser.id, 'DELETED', 'ATTENDANCE_RECORD', `Deleted record for ${existing.user.name} on ${existing.date}`);
    ...
    try {
        ...
        for (const entry of entries) {
            try {
                ...
                yield prismaClient_1.default.attendanceRecord.create({
                    data: {
        ...
        yield (0, activityLogger_1.logActivity)(adminUser.id, 'CREATED', 'ATTENDANCE_BULK', `Bulk attendance: ${created} created, ${skipped} skipped`);
 ...
 */
router.post('/recalculate', authMiddleware_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const adminUser = req.user;
        if (adminUser.role !== 'Admin' && adminUser.role !== 'Super Admin') {
        ...
        for (const record of records) {
            ...
            if (Object.keys(updates).length > 0) {
                yield prismaClient_1.default.attendanceRecord.update({ where: { id: record.id }, data: updates });
                recalculated++;
            }
        }
        yield (0, activityLogger_1.logActivity)(adminUser.id, 'UPDATED', 'ATTENDANCE_RECALCULATE', `Recalculated ${recalculated} records`);
 ...
 */
router.get('/employees', authMiddleware_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
 ...
 */
router.get('/payroll-verification', authMiddleware_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const [pending, rejected, missingPunch, onHold] = yield Promise.all([
