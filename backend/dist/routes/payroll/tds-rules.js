...
router.get('/global-rules/:financial_year', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { financial_year } = req.params;
        let rule = yield prismaClient_1.default.tdsGlobalRule.findUnique({
            where: { financial_year }
        });
        if (!rule) {
            // Provide intelligent defaults
            rule = yield prismaClient_1.default.tdsGlobalRule.create({
                data: {
                    financial_year,
...
router.put('/global-rules/:financial_year', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { financial_year } = req.params;
        const { min_ctc_new_regime, min_ctc_old_regime, default_cycle, auto_apply_ctc_rules } = req.body;
        const updated = yield prismaClient_1.default.tdsGlobalRule.upsert({
            where: { financial_year },
            update: {
...
router.get('/employee-rules', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const [regimes, tdsRules] = yield Promise.all([
...
router.put('/employee-rules/bulk', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.put('/employee-rules/:user_id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = parseInt(req.params.user_id);
        const { financial_year, deduction_rule, estimated_yearly_tds } = req.body;
        const updated = yield prismaClient_1.default.employeeTdsRule.upsert({
            where: { user_id_financial_year: { user_id: userId, financial_year } },
            update: Object.assign(Object.assign(Object.assign({}, (deduction_rule && { deduction_rule })), (estimated_yearly_tds !== undefined && { estimated_yearly_tds })), { status: 'Active' }),
            create: {
                user_id: userId,
                financial_year,
