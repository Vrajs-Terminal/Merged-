...
router.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const types = yield prismaClient_1.default.incentiveType.findMany({
            orderBy: { name: 'asc' }
        });
        res.json(types);
    }
...
router.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const existing = yield prismaClient_1.default.incentiveType.findUnique({ where: { name } });
        if (existing) {
            return res.status(409).json({ error: `Incentive type '${name}' already exists` });
        }
        const created = yield prismaClient_1.default.incentiveType.create({
            data: {
                name,
                incentive_type,
                calculation_method,
        ...
        yield (0, activityLogger_1.logActivity)(null, 'CREATED', 'INCENTIVE_TYPE', name);
...
router.put('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updated = yield prismaClient_1.default.incentiveType.update({
        ...
        yield (0, activityLogger_1.logActivity)(null, 'UPDATED', 'INCENTIVE_TYPE', name);
        res.json(updated);
    }
    catch (error) {
...
router.delete('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const target = yield prismaClient_1.default.incentiveType.delete({
            where: { id: parseInt(id) }
        });
        yield (0, activityLogger_1.logActivity)(null, 'DELETED', 'INCENTIVE_TYPE', target.name);
