...
router.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const slabs = yield prismaClient_1.default.incomeTaxSlab.findMany({
            where,
...
router.post('/bulk', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const createdSlabs = yield prismaClient_1.default.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
            yield tx.incomeTaxSlab.deleteMany({
...
router.delete('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const slab = yield prismaClient_1.default.incomeTaxSlab.findUnique({ where: { id } });
        if (!slab)
            return res.status(404).json({ error: 'Slab not found' });
        if (slab.is_locked)
            return res.status(400).json({ error: 'Cannot delete locked slabs.' });
        yield prismaClient_1.default.incomeTaxSlab.delete({ where: { id } });
