 ...
 */
router.get('/bank-statement', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
 ...
 */
router.get('/pf-esic', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.get('/summary', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (year)
            where.year = parseInt(year);
        const totals = yield prismaClient_1.default.salarySlip.aggregate({
            where,
            _sum: {
 ...
 */
router.get('/hold-salary', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { month, year } = req.query;
        ...
        if (year)
            where.year = parseInt(year);
        const holds = yield prismaClient_1.default.salaryHoldRequest.findMany({
            where,
            include: {
 ...
 */
router.get('/allowances', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
// 8. CTC Audit Report
router.get('/ctc-audit', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const audits = yield prismaClient_1.default.salaryGroupChangeLog.findMany({
            include: {
                user: { select: { name: true } },
...
// 9. Incentive Report
router.get('/incentives', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { month, year } = req.query;
        const result = yield prismaClient_1.default.employeeIncentiveDetail.findMany({
...
router.get('/ff-settlement', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const results = yield prismaClient_1.default.fFSettlement.findMany({
...
router.get('/attendance-sync', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { month, year } = req.query;
        const slips = yield prismaClient_1.default.salarySlip.findMany({
            where: { month: parseInt(month), year: parseInt(year) },
...
router.get('/yearly-statement', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.get('/compliance', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { month, year } = req.query;
        const slips = yield prismaClient_1.default.salarySlip.findMany({
