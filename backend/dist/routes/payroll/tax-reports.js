...
router.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const unassignedRegimeUsers = yield prismaClient_1.default.employeeTaxRegime.findMany({
            where: { financial_year, tax_regime: 'Not Assigned' },
            include: { user: { select: { id: true, name: true } } }
        });
        // 2. Form 16 Tracking Stats
        const form16StatsRaw = yield prismaClient_1.default.form16Document.groupBy({
            by: ['status'],
        ...
        const docStatsRaw = yield prismaClient_1.default.taxBenefitDocument.groupBy({
            by: ['status'],
            where: { financial_year },
            _count: { id: true }
        });
        ...
        const otherIncomeCount = yield prismaClient_1.default.otherIncomeLoss.count({ where: { financial_year, type: 'Income' } });
        const form12BCount = yield prismaClient_1.default.form12BDetail.count({ where: { financial_year } });
        res.json({
            under_tax: {
