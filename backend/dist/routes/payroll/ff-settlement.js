...
router.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (status)
            where.status = status;
        const records = yield prismaClient_1.default.fFSettlement.findMany({
            where,
            include: {
...
router.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const record = yield prismaClient_1.default.fFSettlement.create({
            data: {
        ...
        yield (0, activityLogger_1.logActivity)(null, 'CREATED', 'FF_SETTLEMENT', `User ID: ${user_id}, Net: ${record.net_settlement}`);
...
router.patch('/:id/status', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const record = yield prismaClient_1.default.fFSettlement.update({
        ...
        yield (0, activityLogger_1.logActivity)(null, 'STATUS_UPDATED', 'FF_SETTLEMENT', `ID: ${id}, Status: ${status}`);
        res.json(record);
    }
    catch (error) {
