...
router.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const documents = yield prismaClient_1.default.taxBenefitDocument.findMany({
            where,
            include: {
                user: {
...
router.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const doc = yield prismaClient_1.default.taxBenefitDocument.create({
            data: {
                user_id,
                category_id,
                sub_category_id,
...
router.put('/:id/status', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updated = yield prismaClient_1.default.taxBenefitDocument.update({
            where: { id },
            data: {
                status,
...
router.delete('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = parseInt(req.params.id);
        yield prismaClient_1.default.taxBenefitDocument.delete({ where: { id } });
