...
router.post('/settings', authMiddleware_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updateData = yield prismaClient_1.default.companySetting.upsert({
            where: { key: 'visit_settings' },
            create: { key: 'visit_settings', value: settingsData },
            update: { value: settingsData }
        });
        yield (0, activityLogger_1.logActivity)(adminUser.id, 'UPDATED', 'VISIT_SETTINGS', 'Updated Visit Management settings');
...
router.get('/dashboard', authMiddleware_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const stats = yield prismaClient_1.default.visit.groupBy({
            by: ['status'],
            where: whereClause,
            _count: { status: true }
        });
        const totalVisits = yield prismaClient_1.default.visit.count({ where: whereClause });
...
router.post('/', authMiddleware_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const newVisit = yield prismaClient_1.default.visit.create({
            data: {
                user_id: user.id,
                date: visitDateObj,
                client_name,
        ...
        yield (0, activityLogger_1.logActivity)(user.id, 'CREATED', 'VISIT', `Created visit for ${client_name}`);
...
router.put('/:id', authMiddleware_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const visit = yield prismaClient_1.default.visit.findUnique({ where: { id: visitId } });
        if (!visit)
        ...
        const updatedVisit = yield prismaClient_1.default.visit.update({
            where: { id: visitId },
            data: updateData
        });
        yield (0, activityLogger_1.logActivity)(user.id, 'UPDATED', 'VISIT', `Updated visit #${visitId}`);
 ...
 */
router.post('/:id/check-in', authMiddleware_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = req.user;
        const visitId = parseInt(req.params.id);
        ...
        yield (0, activityLogger_1.logActivity)(user.id, 'UPDATED', 'VISIT_CHECKIN', `Checked in for visit #${visitId}`);
 ...
 */
router.post('/:id/check-out', authMiddleware_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = req.user;
        const visitId = parseInt(req.params.id);
        ...
        const setting = yield prismaClient_1.default.companySetting.findUnique({ where: { key: 'visit_settings' } });
        ...
        yield (0, activityLogger_1.logActivity)(user.id, 'UPDATED', 'VISIT_CHECKOUT', `Checked out from visit #${visitId}`);
 ...
 */
router.post('/:id/approval', authMiddleware_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = req.user;
        const visitId = parseInt(req.params.id);
        ...
        yield (0, activityLogger_1.logActivity)(user.id, 'UPDATED', 'VISIT_APPROVAL', `${approval_status} visit #${visitId}`);
