...
router.get('/', async (req, res) => {
    try {
        ...
        const forms = await prismaClient_1.default.form12BDetail.findMany({
            where,
...
router.get('/:id', async (req, res) => {
    try {
        ...
        const form = await prismaClient_1.default.form12BDetail.findUnique({
            where: { id },
...
router.post('/', async (req, res) => {
    try {
        ...
        const newForm = await prismaClient_1.default.form12BDetail.create({
            data: {
                user_id,
                financial_year,
                previous_company,
...
router.put('/:id', async (req, res) => {
    try {
        ...
        const updated = await prismaClient_1.default.form12BDetail.update({
            where: { id },
            data: updateData
        });
        res.json(updated);
...
router.delete('/:id', async (req, res) => {
    try {
        const id = parseInt(req.params.id);
        await prismaClient_1.default.form12BDetail.delete({ where: { id } });
...
//# sourceMappingURL=form12b.js.map