...
router.get('/', async (req, res) => {
    try {
        ...
        const verifications = await prismaClient_1.default.backgroundVerification.findMany({
            where,
            include: {
...
router.post('/', async (req, res) => {
    try {
        ...
        const verification = await prismaClient_1.default.backgroundVerification.create({
            data: {
...
router.put('/:id', async (req, res) => {
    try {
        ...
        const updated = await prismaClient_1.default.backgroundVerification.update({
            where: { id },
            data: {
                status,
                remarks,
...
router.delete('/:id', async (req, res) => {
    try {
        await prismaClient_1.default.backgroundVerification.delete({ where: { id: Number(req.params.id) } });
