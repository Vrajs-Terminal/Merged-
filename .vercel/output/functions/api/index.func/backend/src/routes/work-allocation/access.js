...
router.get('/', async (req, res) => {
    try {
        const rules = await prismaClient_1.default.workAllocationAccess.findMany({
            include: {
...
router.post('/', async (req, res) => {
    try {
        ...
        const existing = await prismaClient_1.default.workAllocationAccess.findFirst({
        ...
        const circular = await prismaClient_1.default.workAllocationAccess.findFirst({
        ...
        const rule = await prismaClient_1.default.workAllocationAccess.create({
            data: {
...
router.put('/:id', async (req, res) => {
    try {
        ...
        const updated = await prismaClient_1.default.workAllocationAccess.update({
            where: { id: Number(id) },
            data: {
                category_ids,
                access_type,
...
router.delete('/:id', async (req, res) => {
    try {
        const { id } = req.params;
        await prismaClient_1.default.workAllocationAccess.update({
            where: { id: Number(id) },
