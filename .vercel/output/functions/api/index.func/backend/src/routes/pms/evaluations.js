...
const resolveRating = async (score) => {
...
router.get('/', async (req, res) => {
    try {
        ...
        const evals = await prismaClient_1.default.pmsEvaluation.findMany({
            where,
            include: {
...
router.post('/upsert', async (req, res) => {
    try {
        ...
        const evaluation = await prismaClient_1.default.pmsEvaluation.upsert({
            where: {
        ...
        await prismaClient_1.default.pmsAssignEmployee.updateMany({
...
router.get('/report', async (req, res) => {
    try {
        ...
        const rows = await prismaClient_1.default.pmsEvaluation.findMany({
            where,
            include: {
                user: { select: { id: true, name: true } },
                dimension: { select: { id: true, name: true, code: true } },
...
router.delete('/:id', async (req, res) => {
    try {
        await prismaClient_1.default.pmsEvaluation.delete({ where: { id: Number(req.params.id) } });
