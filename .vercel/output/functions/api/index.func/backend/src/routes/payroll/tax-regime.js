...
router.get('/', async (req, res) => {
    try {
        ...
        const regimes = await prismaClient_1.default.employeeTaxRegime.findMany({
            where: {
                user_id: { in: userIds },
        ...
        let processedUsers = users.map(user => {
            ...
            return {
                ...
                name: user.name,
                email: user.email,
                designation: ((_a = user.designation) === null || _a === void 0 ? void 0 : _a.name) || 'N/A',
                department: ((_b = user.department) === null || _b === void 0 ? void 0 : _b.name) || 'N/A',
                branch: ((_c = user.branch) === null || _c === void 0 ? void 0 : _c.name) || 'N/A',
                salary_type: (currentCtc === null || currentCtc === void 0 ? void 0 : currentCtc.salary_type) || 'N/A',
                gross_salary: (currentCtc === null || currentCtc === void 0 ? void 0 : currentCtc.gross_salary) || 0,
                ...regimeDetail
            };
        });
        if (salary_type) {
...
router.put('/:user_id', async (req, res) => {
    try {
        ...
        const updated = await prismaClient_1.default.employeeTaxRegime.upsert({
...
//# sourceMappingURL=tax-regime.js.map