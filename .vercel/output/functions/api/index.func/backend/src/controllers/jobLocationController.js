...
const getJobLocation = async (req, res) => {
    try {
        ...
        const jobLocation = await prismaClient_1.default.jobLocation.findUnique({
...
const createJobLocation = async (req, res) => {
    try {
        ...
        const jobLocation = await prismaClient_1.default.jobLocation.create({
            data: {
...
const updateJobLocation = async (req, res) => {
    try {
        ...
        const jobLocation = await prismaClient_1.default.jobLocation.update({
            where: { employeeId: parseInt(employeeId) },
            data: {
                countries: JSON.stringify(countries),
                states: JSON.stringify(states)
...
const deleteJobLocation = async (req, res) => {
    try {
        const { employeeId } = req.params;
        await prismaClient_1.default.jobLocation.delete({
            where: { employeeId: parseInt(employeeId) }
        });
...
//# sourceMappingURL=jobLocationController.js.map