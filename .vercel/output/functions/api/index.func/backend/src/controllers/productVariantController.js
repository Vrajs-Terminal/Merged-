...
const getVariant = async (req, res) => {
    try {
        const { id } = req.params;
        const variant = await prismaClient_1.default.productVariant.findUnique({
...
const createVariant = async (req, res) => {
    try {
        ...
        const variant = await prismaClient_1.default.productVariant.create({
            data: {
...
const updateVariant = async (req, res) => {
    try {
        ...
        const variant = await prismaClient_1.default.productVariant.update({
            where: { id: parseInt(id) },
            data: {
...
const deleteVariant = async (req, res) => {
    try {
        const { id } = req.params;
        await prismaClient_1.default.productVariant.delete({
            where: { id: parseInt(id) }
        });
...
const toggleVariantStatus = async (req, res) => {
    try {
        ...
        const updated = await prismaClient_1.default.productVariant.update({
            where: { id: parseInt(id) },
