...
const getCategory = async (req, res) => {
    try {
        const { id } = req.params;
        const category = await prismaClient_1.default.productCategory.findUnique({
...
const createCategory = async (req, res) => {
    try {
        ...
        const category = await prismaClient_1.default.productCategory.create({
            data: {
                name,
                description,
                status
...
const updateCategory = async (req, res) => {
    try {
        ...
        const category = await prismaClient_1.default.productCategory.update({
            where: { id: parseInt(id) },
            data: {
                ...(name && { name }),
...
const toggleCategoryStatus = async (req, res) => {
    try {
        ...
        const updated = await prismaClient_1.default.productCategory.update({
            where: { id: parseInt(id) },
