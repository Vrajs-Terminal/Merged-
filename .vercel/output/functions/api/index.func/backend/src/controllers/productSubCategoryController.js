...
const getSubCategory = async (req, res) => {
    try {
        const { id } = req.params;
        const subCategory = await prismaClient_1.default.productSubCategory.findUnique({
...
const createSubCategory = async (req, res) => {
    try {
        ...
        const subCategory = await prismaClient_1.default.productSubCategory.create({
            data: {
...
const updateSubCategory = async (req, res) => {
    try {
        ...
        const subCategory = await prismaClient_1.default.productSubCategory.update({
            where: { id: parseInt(id) },
            data: {
                ...(name && { name }),
...
const deleteSubCategory = async (req, res) => {
    try {
        const { id } = req.params;
        await prismaClient_1.default.productSubCategory.delete({
            where: { id: parseInt(id) }
        });
...
const toggleSubCategoryStatus = async (req, res) => {
    try {
        ...
        const updated = await prismaClient_1.default.productSubCategory.update({
            where: { id: parseInt(id) },
