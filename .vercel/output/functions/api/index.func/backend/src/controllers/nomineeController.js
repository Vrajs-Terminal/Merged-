...
// ============================================
const createNominationType = async (req, res) => {
    try {
...
const getNominationTypes = async (req, res) => {
    try {
...
const updateNominationType = async (req, res) => {
    try {
        const { id } = req.params;
        const { name, description, allowMultiple } = req.body;
...
const deleteNominationType = async (req, res) => {
    try {
        const { id } = req.params;
...
// ============================================
const addEmployeeNominee = async (req, res) => {
    try {
...
const getEmployeeNominees = async (req, res) => {
    try {
...
const bulkUploadNominees = async (req, res) => {
    try {
...
const deleteEmployeeNominee = async (req, res) => {
    try {
        const { id } = req.params;
...
//# sourceMappingURL=nomineeController.js.map